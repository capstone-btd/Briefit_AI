...
현재 코드와 2025년 기여 커밋을 대조했습니다. 약 4,000건 수집·3,000건 파인튜닝과 모델 비교 경험은 작성자가 확인했습니다. 당시 체크포인트와 연결된 ROUGE 로그, 후처리 전후의 정량 비교는 공개자료에서 확인하지 못했습니다. 현재 GPT-OSS 경로에서도 중립성 프롬프트가 편향 제거 또는 사실 보존을 증명하지는 않습니다.
...
소스 대조 기준: [`35f3a19`](https://github.com/capstone-btd/Briefit_AI/tree/35f3a19a0481bdef8a06830ecd134d072ac6bf01), 소스 대조 2026-09-12.
